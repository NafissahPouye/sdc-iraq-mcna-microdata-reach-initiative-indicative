...
#Import data
setwd("C:/Users/LENOVO T46OS/Desktop/sdc-iraq-mcna-microdata-reach-initiative_representative_indicative")
data <- read_excel("data.xlsx", sheet = "hh_data_indicative")


#Select key variables                   
selectedKeyVars <- c('population_group', 'district','hhh', 'age_respondent',
                     'gender_respondent','num_hh_member')

#select weights
weightVars <- c('weights')

#Convert variables into factors
cols =  c('population_group', 'district','hhh', 'age_respondent',
          'gender_respondent','num_hh_member')
